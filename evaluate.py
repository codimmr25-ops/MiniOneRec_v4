...
def load_causal_lm_for_eval(model_path: str, model_init_kwargs: dict):
    ...
    model = AutoModelForCausalLM.from_pretrained(peft_config.base_model_name_or_path, **model_init_kwargs)
...
def main(
    ...
    model = load_causal_lm_for_eval(base_model, {"torch_dtype": torch.bfloat16, "device_map": "auto"})
    model.eval()
